...
// Rutas
const booksRoutes = require("./routes/books.routes") //importa las rutas a habilitar
...
// Rutas
//API
app.use('/api/books', checkApiKey, booksRoutes); //habilita las rutas, puedes añadir las que necesites, con checkApiKey están bloqueadas con API KEY
